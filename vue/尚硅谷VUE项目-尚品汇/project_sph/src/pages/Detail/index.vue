<template>
  <div class="detail">
    ...
    <section class="con">
      <!-- 导航路径区域 -->
      <div class="conPoin">
        <span v-for="(item, index) in categoryView" :key="index">{{ item }}</span>
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <Zoom ref="zoom" :skuImageList="skuInfo.skuImageList" />
          <!-- 小图列表 -->
            ...
            <div class="chooseArea">
              ...
              <dl v-for="item in spuSaleAttrList" :key="item.id">
                ...
                <dd
                  ...
                  @click="changeActive(value, item.spuSaleAttrValueList)"
                >
