      ...
      <div class="title clearfix">
        ...
        <div class="fr">
          <ul class="nav-tabs clearfix">
            <li class="active" v-for="(item, index) in floorObj.navList" :key="index">
      ...
      <div class="tab-content">
        <div class="tab-pane">
          <div class="floor-1">
            <div class="blockgary">
              <ul class="jd-list">
                <li v-for="(item, index) in floorObj.keywords" :key="index">{{ item }}</li>
              </ul>
            ...
            <div class="split">
              ...
              <div class="floor-conver-pit" v-for="(item, index) in recommendListLeft" :key="index">
                <img :src="item" />
              </div>
            </div>
            ...
            <div class="split">
              ...
              <div
                ...
                v-for="(item, index) in recommendListRight"
                :key="index"
              >
                <img :src="item" />
              </div>
